...
ARCHSPECIFIC_VARS+=POSTPROCESS_ENV_SCRIPT
ARCHSPECIFIC_VARS+=USE_TIRPC
...
FILTERED_TSCRS=$(filter-out $(DISABLED_TESTSCRIPTS)      ,$(TESTSCRIPTS))
...
CPSW_STATIC_LIBS = cpsw.a yaml-cpp.a pthread rt dl
